  ...
  <div class="introduction-container" id="introduction">
    ...
    <div class='introduction-section' :class="{fadeIn:visible}" v-show="visible">
      ...
      <div class="greeting-container">
        ...
        特定行政書士の寺町です。<br><br>
        日本も高齢化社会を迎え、相続手続き、空き家・農地等不動産の処分、成年後見制度の必要性など、ご家族の悩みも多種多様になりました。<br><br>
        小職は遺言・成年後見制度の相談から、相続開始後の財産調査・遺産分割協議書作成など幅広く相続関係の相談に対応してまいりました。<br><br>
        また、兼業で宅建業、愛電（株）の登録もございますので、不動産の処分についても対応することができますし、墓じまい等の助言・紹介なども必要に合わせて対応可能です。<br><br>
        これら相続に関しては、被相続人・相続人の皆様が現在から将来に向けて安心して相続手続きができるように努めてまいります。<br><br>
        また、建設業・産業廃棄物の許可申請や、一般的な各種申請・書類作成なども幅広くサポートさせて頂きますので、<br>まずはお気軽にご相談ください。<br><br>
